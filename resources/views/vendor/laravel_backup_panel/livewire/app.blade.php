        ...
        <div class="col-12 table-responsive">
            <div class="card shadow-sm mb-4">
                <div class="card-header d-flex align-items-end">
                    <button class="btn bg-navy elevation-5 btn-sm btn-refresh ml-auto" wire:loading.class="loading"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                ...
                                @if ($deletingFile)
                                    <span class="text-muted">
                                        Está seguro que desea borrar el respaldo creado el
                                        {{ $deletingFile['date'] }} ?
                                    </span>
                                @endif
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn bg-navy elevation-5 delete-button"
                                    wire:click="deleteFile">Borrar</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            ...
            const backupFun = function(option = '') {
                Toastify({
                    text: 'Creando una nueva copia de seguridad en segundo plano...' + (option ? ' (' +
                        option + ')' : ''),
                    duration: 5000,
                    gravity: 'bottom',
                    position: 'right',
